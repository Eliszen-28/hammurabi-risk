...
import SalesAssistantButton from "../SalesAssistantButton";
...
export default function ServicePage({slug}:{slug:ServiceSlug}){
  ...
  return <main className="detail-page">
    ...
    <section className="detail-hero shell"><div><p className="eyebrow">{d.kicker}</p><h1>{d.title}</h1><p className="lead">{d.intro}</p><SalesAssistantButton /></div><div className="detail-mascot"><img src={slug==="empresas"||slug==="riesgos"?"/mascota-perfil.png":"/mascota-camina.png"} alt="Mascota Hammurabi Risk"/><p>{d.accent}</p></div></section>
