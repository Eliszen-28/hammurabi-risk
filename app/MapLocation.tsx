...
export default function MapLocation(){
  ...
  return <section className="map-section" aria-labelledby="map-title">
    <div className="shell map-heading">
      ...
      <div><p>Blvd. Gómez Morín, local 17<br/>Ciudad Juárez, Chihuahua</p><a className="desktop-directions" href={DIRECTIONS_URL} target="_blank" rel="noreferrer">Abrir indicaciones <span aria-hidden="true">↗</span></a></div>
    </div>
    <nav className="shell map-mobile-actions" aria-label="Abrir ubicación en una aplicación de mapas">
      <a className="maps-button" href={DIRECTIONS_URL} target="_blank" rel="noreferrer"><span aria-hidden="true">📍</span>Google Maps</a>
      <a className="waze-button" href={WAZE_URL} target="_blank" rel="noreferrer"><span aria-hidden="true">➤</span>Waze</a>
    </nav>
